...
# from neurodex.data.models import (ActivatorTarget,
#                                   FunctionActivatorParameterData, LayerType,
...
# @model_blueprint.route('/<model:model>/layers/<model_layer_id>/data/<parameter_id>', methods=['PUT'])
# @jwt_required
# def put_parameter_data(model: Model, model_layer_id: str, parameter_id: int):
...
#         ModelLayerParameterData.fk_layer_type_parameter_id == parameter_id).first()

#     value = PrimitiveValue(value=new_value)

#     if(param_data is None):
#         param_data = ModelLayerParameterData(fk_model_layer_id=model_layer_id,
#                                              fk_layer_type_parameter_id=parameter_id, value=value)
...
# @model_blueprint.route('/<model:model>/activators/<model_activator_id>/data/<parameter_id>', methods=['PUT'])
# @jwt_required
# @own_model
# def put_activator_parameter_data(model: Model, model_activator_id: int, parameter_id: int):
#     data = request.json
#     new_value = data['newValue']

#     value_entity = PrimitiveValue(value=new_value)
#     parameter_data = FunctionActivatorParameterData(
#         fk_model_activator_id=model_activator_id, value=value_entity, fk_function_parameter_id=parameter_id,)
