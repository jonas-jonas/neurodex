    ...
    <div className="w-full max-w-xs mx-auto pt-8">
      <div className="bg-white shadow-md rounded mb-4 mx-auto">
        <div className="w-full">
          <LoginPageStateButton state={LoginPageState.LOGIN} currentState={loginPageState} onClick={setLoginPageState}>
            LOGIN
        ...
        <div className="px-8 pt-6 pb-8">
          ...
          {loginPageState === LoginPageState.REGISTER && <RegisterForm setLoginPageState={setLoginPageState} />}
        </div>
      </div>
    </div>
  );
